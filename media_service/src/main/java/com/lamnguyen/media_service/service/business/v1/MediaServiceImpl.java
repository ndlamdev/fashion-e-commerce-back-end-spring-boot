...
public class MediaServiceImpl implements IMediaService {
    ...
    public Map<String, MediaInfo> getMediaByIds(List<String> ids) {
        ...
        var listTasks = new ArrayList<CompletableFuture<Void>>();
        ids.forEach(id -> listTasks.add(CompletableFuture.runAsync(() -> {
            try {
    ...
    public Map<String, MediaInfo> getMediaByNames(List<String> names) {
        ...
        var listTasks = new ArrayList<CompletableFuture<Void>>();
        names.forEach(name -> listTasks.add(CompletableFuture.runAsync(() -> {
            try {
    ...
    public List<MediaDto> getAll() {
        return mediaManage
                .getAll()
                .or(() ->
                        mediaManage.cacheAll(() ->
                                Optional.ofNullable(mediaMapper.toDtos(mediaRepository.findAll()))))
