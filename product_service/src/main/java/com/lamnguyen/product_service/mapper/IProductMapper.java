...
public interface IProductMapper {
    @Mappings({@Mapping(target = "id", ignore = true), @Mapping(target = "lock", ignore = true), @Mapping(target = "createBy", ignore = true), @Mapping(target = "createAt", ignore = true), @Mapping(target = "updateBy", ignore = true), @Mapping(target = "updateAt", ignore = true), @Mapping(target = "available", ignore = true), @Mapping(source = "collection", target = "collection", qualifiedByName = "toCollection"), @Mapping(source = "title", target = "seoAlias", qualifiedByName = "toSeoAlias"), @Mapping(source = "title", target = "titleSearch", qualifiedByName = "toTitleSearch"),})
    ...
    com.lamnguyen.product_service.protos.ProductResponseGrpc toProductResponseGrpc(ProductResponse response, IImageMapper imageMapper, IImageOptionsValueMapper imageOptionsValueMapper, IOptionMapper optionMapper, IOptionItemMapper optionItemMapper, IGrpcMapper grpcMapper);


    @AfterMapping
    default void afterMapping(ProductResponse response, @MappingTarget com.lamnguyen.product_service.protos.ProductResponseGrpc.Builder builder, IImageMapper imageMapper, IImageOptionsValueMapper imageOptionsValueMapper, IOptionMapper optionMapper, IOptionItemMapper optionItemMapper, IGrpcMapper grpcMapper) {
    ...
    List<AdminSubProductResponse> toAdminSubProductResponse(List<Product> products);
}
